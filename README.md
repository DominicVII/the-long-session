...
**Build stamp: `20260917q`.** Saves live in the browser (`localStorage`). Continue never deletes a career. Sleep is a clock, not a 3D rebuild.
...
Grok.me wrapper iframes `/session.html?v=20260917q`.
