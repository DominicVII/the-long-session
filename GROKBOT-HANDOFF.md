...
Current stamp: **`20260921a`** (`<meta name="onum-build" content="20260921a">`).

Grok.me wrapper: `/session.html?v=20260921a` (file `src/lib/onum-build.ts` in the grok app: `export const ONUM_BUILD = "20260921a"`).

If you change the HTML, bump the letter (`20260921b`, …) in **meta + wrapper together**, then commit all three HTML copies.
